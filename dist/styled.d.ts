import { TextKitProps, ViewKitProps, FlexRowProps, CircleViewProps } from './types';
...
export declare const Whitespace: import("styled-components").StyledComponent<typeof import("react-native").View, any, ViewKitProps, never>;
